...
<p align="center">
  <a href="https://github.com/GarageTech/jerkmaster">Repository</a> ·
  <a href="docs/installation.md">Installation</a> ·
  <a href="docs/hardware.md">Hardware</a> ·
  <a href="docs/wiring.md">Wiring</a> ·
  <a href="COMMUNITY_ANNOUNCEMENT.md">Community announcement</a>
</p>
...
- Diagnostic status reporting:
  - Normal Work
  - Electronics bay high temperature
  - Electronic bay overheating
  - Sensor disconnected
  - SSR timeout / heating-chain failure indication
  - MCU disconnected
...
VEVOR, Raspberry Pi, BTT, Omron, Mean Well, and the other manufacturers mentioned here are not sponsors or affiliates of this project. Their hardware was simply useful for the build. They are, of course, welcome to change the sponsorship situation.
...
| Local storage | User-created and edited ingredients, recipes, and profiles |
...
```text
http://jerkmaster.local/?moonraker=http://192.0.2.50:7125
```
...
tools/         Local development server
```
