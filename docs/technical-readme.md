...
- SKR Y-STOP / `P1.28` user/action button with short-press action handling and long-press safe shutdown request.
...
MAX98357A sound cues for startup, beer scene, action feedback, and shutdown.
