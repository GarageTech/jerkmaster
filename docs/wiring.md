...
| 12 V chamber LED light | FAN1 | `P2.4` |
...
- Verify that the FAN1 output supply is exactly 12 V and that the LED light current is within the board output rating before connecting it.
- Observe LED polarity. The SKR FAN1 MOSFET output switches the negative side of the load.
